...
import (
	...
	"github.com/calypsodb/calypso/octopus"
...
// Bitcask is a struct that represents an on-disk LSM and WAL data structure
...
// Close() as this is the only way to clean up the lock held by the open
// database.
